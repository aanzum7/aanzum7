...
I’m an experienced **Data Analyst** passionate about transforming data into insights and strategies.  
I specialize in **data analysis**, **visualization**, and **AI-driven research**, focusing on:
...
Currently, I’m exploring **advanced ML/NLP research** and **building intelligent analytics systems**.  
...
📅 *2016 – 2020* | GPA: **3.89 / 4.00**

**Thesis:**  
🧩 *Traffic Sign Recognition System (TSRS)* using **SVM** and **CNN**

---

### 🧾 Publications

- 📘 **Machine Learning Algorithm to Predict Fraudulent Loan Requests (2021)**  
  _Published in IEEE Xplore_ — enhanced financial security using ML  
- 📗 **Traffic Sign Recognition System (2020)**  
  _Published in Springer_ — SVM + CNN for traffic sign detection  
...
| 🧩 Project | 💬 Description |
|------------|----------------|
| **Recommendation Engine** | Personalized recommender using Transformers + CF |
| **News NLP Pipeline** | Topic modeling & entity extraction for Bengali news |
| **Fraud Loan Predictor** | ML-based fraud detection — IEEE publication |
| **Interactive Transport Dashboard** | Streamlit + Plotly dashboard for city transport analytics |
...
🌍 I enjoy traveling  
🎬 I love watching movies — recommend me one!  
...
I’m open to:
- 🧠 ML & NLP Research Projects  
- 🚀 Building Recommendation Engines  
- 📈 Data-driven Growth Strategies  

💬 **Let’s brainstorm and innovate together!**
...
<p align="center">
  ...
  <a href="https://sites.google.com/view/anzum7"><img src="https://img.shields.io/badge/Portfolio-FF7139?style=for-the-badge&logo=firefox&logoColor=white"/></a>
</p>
